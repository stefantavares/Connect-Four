...
const displayMessage2 = document.getElementById('display2');
...
function render() {
	...
	if (winner === 'T') {
		...
		displayMessage2.textContent = `PRESS REPLAY TO PLAY AGAIN!`;
	} else if (winner) {
		...
		displayMessage2.textContent = `TRY TO CONNECT FOUR!`;
	}
}
